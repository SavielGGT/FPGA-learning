...
HD_PWD='C:/FPGA-learning/HW3/expr_plain/expr_plain.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log expr_plain.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source expr_plain.tcl
