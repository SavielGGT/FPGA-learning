...
HD_PWD='C:/FPGA-learning/HW3/expr_plain/expr_plain.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log expr_plain.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source expr_plain.tcl -notrace
