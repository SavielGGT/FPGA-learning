...
HD_PWD='C:/FPGA-learning/HW1/HW1_latch/HW1_latch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log latch_mux.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source latch_mux.tcl
